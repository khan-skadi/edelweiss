        ...
        <div className={classes.footerTop}>
          <div className={classes.container}>
            ...
            <div className={classes.footerLeft}>
              <div className={classes.leftTitle}>Services</div>
            ...
            <div className={classes.footerMiddle}>
              ...
              <div className={classes.middleSocial}>
                <p>Follow Us On</p>
                <a
                ...
                >
                  <Icon className={classes.icon} component={FacebookIcon} />
                </a>
                <a
                  className={classes.socialInsta}
                  href="#!"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Icon className={classes.icon} component={InstagramIcon} />
                </a>
              </div>
            </div>
            {/* Right */}
            <div className={classes.footerRight}>
              <div className={classes.rightTitle}>Projects</div>
